...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1962930212;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<Uint8List> crateApiMatrixDownloadMediaSourceBytes({
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<Uint8List> crateApiMatrixDownloadMediaSourceBytes({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_String(mediaSourceJson, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 10,
        ...
        constMeta: kCrateApiMatrixDownloadMediaSourceBytesConstMeta,
        argValues: [mediaSourceJson],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiMatrixDownloadMediaSourceBytesConstMeta =>
      const TaskConstMeta(
        debugName: "download_media_source_bytes",
        argNames: ["mediaSourceJson"],
      );
  ...
  ChatMessage sse_decode_chat_message(SseDeserializer deserializer) {
    ...
    var var_mediaSourceJson = sse_decode_opt_String(deserializer);
    ...
    return ChatMessage(
      ...
      mediaSourceJson: var_mediaSourceJson,
  ...
  void sse_encode_chat_message(ChatMessage self, SseSerializer serializer) {
    ...
    sse_encode_opt_String(self.mediaSourceJson, serializer);
